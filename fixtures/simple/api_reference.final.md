...
Access tokens expire after 12 hours. Refresh tokens are valid for 30 days.
...
API requests are limited to 200 requests per minute per client. Exceeding this limit returns a 429 status code.
